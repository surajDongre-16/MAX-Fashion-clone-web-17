...
<div id="high">
    <div class="upper lame">
        ...
        <div id="sub">
            <input placeholder="Please enter an email adress" style="width: 280px; background-color: #f7f8f7; border: 1px #f7f8f7; font-family: 'Roboto', sans-serif; font-size: 16px; padding-left: 30px;"/>
